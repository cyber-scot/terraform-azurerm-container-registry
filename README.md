...
| <a name="output_registry_identities"></a> [registry\_identities](#output\_registry\_identities) | The identities associated with the Azure Container Registry tasks. |
